    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/disasters/**").hasAnyRole("ADMIN", "COORDINATOR")
                .requestMatchers(HttpMethod.PUT, "/disasters/**").hasAnyRole("ADMIN", "COORDINATOR")
                .requestMatchers(HttpMethod.DELETE, "/disasters/**").hasRole("ADMIN")
                .requestMatchers("/assignments/**").hasAnyRole("ADMIN", "COORDINATOR")
                .requestMatchers("/inventory/**").hasAnyRole("ADMIN", "COORDINATOR")
